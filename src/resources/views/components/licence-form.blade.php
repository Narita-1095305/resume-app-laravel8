...
<div x-data="licenceHandler()">
    <template x-for="(field, index) in fields" :key="index">
        <div class="border-2 border-black-500 bg-gray-50 p-2 mb-1">
            ...
            <div class="flex mb-2">
                <x-input x-model="field.licence_year" class="block w-1/3" min="1960" max="2050" type="number" name="licence_year[]" required/>
                <p class="block font-medium self-center mx-1 mt-1">年</p>
                <x-input x-model="field.licence_month" class="block w-1/4" min="1" max="12"  type="number" name="licence_month[]" required/> 
