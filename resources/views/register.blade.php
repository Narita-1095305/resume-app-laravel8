        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                ...
                <div class="flex">
                    ...
                    <x-input id="birth_year" class="block mt-1 w-1/4" type="number" name="birth_month" :value="old('birth_month')" required /> 
            ...
            <div class="mt-4">
                ...
                <div class="flex">
                    <x-input id="address" class="block mt-1 w-full" type="text" name="address" :value="old('family_name')" required />
                </div>
            </div>
            ...
            <div class="mt-4">
                ...
                <div class="flex">
                    <x-input id="address" class="block mt-1 w-full" type="text" name="address" :value="old('family_name')" />
                </div>
            </div>
            ...
            <div class="mt-4">
                ...
                <div class="flex">
                    <x-input id="address_furigana" class="block mt-1 w-full" type="text" name="address_furigana" :value="old('family_name')" required />
                </div>
            </div>
