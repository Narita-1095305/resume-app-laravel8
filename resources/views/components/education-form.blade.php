...
<div x-data="educationHandler()">
    ...
    <div class="border-2 border-black-500 bg-gray-50 p-2 mb-1">
        ...
        <input x-model="field.education_background" type="text" name="education_background[]" class="shadow-sm border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500 dark:shadow-sm-light">
